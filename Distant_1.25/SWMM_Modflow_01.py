...
SWMM_path = 'mukilteo_proximate_1.25%.inp'
...
np.save('HD_TS_SUM_Proximate_1.npy', HD_TS_SUM)
np.save('HD_TS_VAR_Proximate_1.npy', HD_TS_VAR)

max_index = np.nanargmax(HD_TS_SUM)
min_index = np.nanargmin(HD_TS_SUM)

np.save('HD_TS_MAX_Proximate_1.npy', HD_TS[max_index])
np.save('HD_TS_MIN_Proximate_.npy', HD_TS[min_index])
