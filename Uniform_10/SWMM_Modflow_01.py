...
SWMM_path = 'mukilteo_adjacent_10%.inp'
...
np.save('HD_TS_SUM_Adjacent_10.npy', HD_TS_SUM)
np.save('HD_TS_VAR_Adjacent_10.npy', HD_TS_VAR)

max_index = np.nanargmax(HD_TS_SUM)
min_index = np.nanargmin(HD_TS_SUM)

np.save('HD_TS_MAX_Adjacent_10.npy', HD_TS[max_index])
np.save('HD_TS_MIN_Adjacent_10.npy', HD_TS[min_index])